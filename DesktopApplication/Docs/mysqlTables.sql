...
CREATE TABLE IF NOT EXSISTS DoctorPatientTreatment(id INTEGER AUTO_INCREMENT PRIMARY KEY, doctorId CHAR(36), patientId CHAR(36), FOREIGN KEY (patientId) REFERENCES Patient(id), FOREIGN KEY (doctorId) REFERENCES Doctor(id))
